...
urlpatterns = [
    ...
    path("api/v1/profiles/", ProfileAPIList.as_view(), name="profile_list"),
    path("api/v1/profiles/<int:profile_id>/", ProfileAPIUpdate.as_view(), name="profile-update"),
    path("api/v1/profiles/reset-tg/<int:profile_id>/", ResetTelegramIDView.as_view(), name="reset-tg"),
    path("api/v1/profiles/tg/<int:telegram_id>/", ProfileByTelegramIDView.as_view(), name="profile-by-tg-id"),
    path("api/v1/profiles/<int:id>/delete/", ProfileAPIDestroy.as_view(), name="profile-delete"),
    path("api/v1/profiles/create/", CreateUserView.as_view(), name="profile-create"),
    path("api/v1/profiles/<str:username>/", UserProfileView.as_view(), name="user-profile"),
    path("api/v1/current-user/", CurrentUserView.as_view(), name="current-user"),
    path("api/v1/client-profiles/", ClientProfileView.as_view(), name="client-profile-list"),
    path("api/v1/client-profiles/<int:profile_id>/", ClientProfileUpdate.as_view(), name="client-profile-update"),
    path("api/v1/coach-profiles/", CoachProfileView.as_view(), name="coach-profile-list"),
    path("api/v1/coach-profiles/<int:profile_id>/", CoachProfileUpdate.as_view(), name="coach-profile-update"),
