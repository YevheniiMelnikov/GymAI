...
- Whenever possible, always try to separate helper functions into a separate module (or package) with utilities, if appropriate. Often, such places already exist; just find the right one.
